	...
	<body>
	    <div id="header">
	        <div class="bandeauhaut">
				...
				<div id="headerdroit">
					<a href="https://www.dropbox.com/s/iblab7uw5wsk6x5/Accueil.html?raw=1"><div class="Bouton"><p>Se connecter</p></div></a>
				</div>
			</div>
			<div class="bandeaubas">
				<div class="bandeauhaut">
					<form method="post" action="">
						...
						<input type="Button" value="Recherche d'événement" class="boutonrecherche"/>
					</form>
				</div>
				<div class="bandeaubas">		
		...
		<div id="bandeau3">
			...
			<a href="#"><div class="Bouton"><p>S'inscrire/ se connecter</p></div></a>
		</div>
